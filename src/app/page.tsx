...
export default function Home() {
  return (
<div className="font-comic bg-[url('/boot_cactus_composite.png')] bg-[length:125px_80px] bg-repeat p-10 md:p-20 h-auto bg-white">
<div className='md:flex'>
  <div className="text-black bg-white w-[400px] lg:ml-40 md:p-8">
    <div className='bg-white m-4 h-25 relative'>
...
<div className="m-4">if you are like me you must drive a car to commute towork or around town for various purposes such asbuying food to LIVE or visiting the HOSPITALb8t a major probem i have run into lately is this:why does the gas station music have to be so BAD?here me out…what if someone made music FOR gas stations and gaspumps and not let them play some lousy playlist? OK. sohere is what i have done. i made music for gas stationsi would like to petition wawa to play this album sopeople can hear gas intended music</div>
  <ContactForm/>
  </div>
